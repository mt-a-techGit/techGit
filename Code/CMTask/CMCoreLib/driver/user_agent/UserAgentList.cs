...
{
    internal class UserAgentList
    {
        private readonly string[] iTitles = 
        {
        ...
        public int GetSize() { return iTitles.Length; }
        public string GetItem(int index) { return iTitles[index]; }
    }
}
